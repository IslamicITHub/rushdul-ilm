# 🤖 AI AGENT SYSTEM PROMPT — Rushd-ul-Ilm (رشد العلم)
# AI-Powered Islamic Knowledge Q&A Android App
# Version 3.0 | Developer: Shaik Hidayatullah, Kurnool, Andhra Pradesh, India
#
# ════════════════════════════════════════════════════════════════════
# HOW TO USE THIS FILE:
#   - For Claude Code:    paste contents of the SYSTEM PROMPT block below into
#                         your CLAUDE.md file OR pass with --system-prompt flag
#   - For Gemini-CLI:     paste into gemini system instructions or use
#                         `gemini --system "$(cat AI_SYSTEM_PROMPT.md)"`
#   - For OpenAI Codex:   paste into codex.md OR use
#                         `codex --system-prompt "$(cat AI_SYSTEM_PROMPT.md)"`
# ════════════════════════════════════════════════════════════════════

---

## ════════ SYSTEM PROMPT START (copy everything below this line) ════════
